...
public class SimonSays extends KeyAdapter {
	...
	public void run() {
		...
		JOptionPane.showMessageDialog(null, "Press the matching key when 'Simon says' || If Simon doesn't say, press any other key" );
	...
	public void keyPressed(KeyEvent e) {
		...
		// say..."
		else if (keyCode != imageIndex && simonSays != true) {
	...
	private void showImage() {
		...
		String words = "";
		if (r == 0) {
			words = "Simon says press this key";
			simonSays = true;
		}
		else if (r == 1) {
			words = "Press this key";
			simonSays = false;
		}
